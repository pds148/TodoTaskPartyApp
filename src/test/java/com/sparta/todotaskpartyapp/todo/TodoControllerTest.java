...
class TodoControllerTest extends ControllerTest implements TodoTest {
    ...
    class getTodo {
        ...
        void getTodo_success() throws Exception {
            // given
            given(todoService.getTodoDetails(eq(TEST_TODO_ID))).willReturn(TEST_TODO_RESPONSE_DTO);
        ...
        void getTodo_fail_todoIdNotExist() throws Exception {
            // given
            given(todoService.getTodoDetails(eq(TEST_TODO_ID))).willThrow(new IllegalArgumentException());
    ...
    void getTodoList() throws Exception {
        ...
        verify(todoService, times(1)).getUserTodoList();
    }
